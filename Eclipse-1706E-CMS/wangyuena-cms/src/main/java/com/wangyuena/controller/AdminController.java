...
public class AdminController {
	 ...
	 * 友情链接
	 */
	@GetMapping("toLinkList")
	public String toLinkList(HttpServletRequest request) {
	...
	public boolean userupdate(HttpServletResponse response,HttpServletRequest request,User user) throws ServletException, IOException {
