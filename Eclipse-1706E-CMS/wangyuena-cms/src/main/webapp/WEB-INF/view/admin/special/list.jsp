		...
		<table class="table table-sm  table-hover table-bordered ">
			...
			<c:forEach items="${specialList}" var="special" varStatus="index">
				<tr align="center">
					...
					<td>
						<button type="button"  class="btn btn-outline-warning"    onclick="addArticle(${special.id})" >追加文章</button> 
					    <button type="button" class="btn btn-outline-success"     onclick="modify(${special.id})">修改专题</button> 
